...
← [[Agenda/Hebdomadier/<% moment(tp.file.title, 'W-YYYY').subtract(7, 'd').format('YYYY/W-YYYY') %>|précédente]] | [[Agenda/Hebdomadier/<% moment(tp.file.title, 'W-YYYY').add(7, 'd').format('YYYY/W-YYYY') %>|suivante]] →
