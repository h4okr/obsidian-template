...
---
# <% moment(tp.file.title,'YYYY[ Q]Q').format("[Trimestre n°]Q") %> [[Agenda/Annuel/<% moment(tp.file.title, 'YYYY[ Q]Q').format('[année ]YYYY') %>|<% moment(tp.file.title,'MMMM YYYY').format("YYYY") %>]]
